import svgPaths from "./svg-rc5r3m6hys";

function Text() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Text">
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[#1f1f32] text-[16px]">Exit to Studio?</p>
    </div>
  );
}
...
function AlertOctagon() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="alert-octagon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="alert-octagon">
          <path d={svgPaths.p2e6f4380} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function IconContainer() {
  return (
    <div className="bg-[#b3141d] content-stretch flex items-start p-[4px] relative rounded-[24px] shrink-0" data-name="Icon Container">
      <AlertOctagon />
    </div>
  );
}
...
function AlertPictogram() {
  return (
    <div className="absolute bg-[#fff0f3] content-stretch flex items-center justify-center left-0 p-[8px] rounded-[24px] top-[2px]" data-name="Alert Pictogram">
      <IconContainer />
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Text">
      <p className="basis-0 font-['Inter:Regular',sans-serif] grow leading-[22px] min-h-px min-w-px not-italic relative shrink-0 text-[#3d3c52] text-[14px]">This will stop capturing and return you to Studio. Current steps won’t be saved.</p>
    </div>
  );
}
...
function Logout() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="logout">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="logout">
          <path d={svgPaths.p1a8cffc0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function MainCta() {
  return (
    <div className="bg-[#b3141d] content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[16px] py-[12px] relative rounded-[4px] shrink-0" data-name="Main CTA">
      <Logout />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-nowrap text-white">Exit</p>
    </div>
  );
}
...
function AlertModal() {
  return (
    <div className="absolute content-stretch flex flex-col isolate items-center left-0 overflow-clip rounded-[8px] shadow-[0px_4px_30px_10px_rgba(0,0,0,0.08),0px_8px_28px_4px_rgba(0,0,0,0.1),0px_6px_22px_4px_rgba(0,0,0,0.12)] top-0" data-name="Alert Modal">
      <ModalHeader />
      <Body />
      <ModalFooter />
    </div>
...
export default function Exit() {
  return (
    <div className="relative size-full" data-name="Exit">
      <AlertModal />
    </div>
  );
}