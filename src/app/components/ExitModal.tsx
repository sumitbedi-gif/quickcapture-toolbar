...
import svgPaths from "../../imports/svg-rc5r3m6hys";
...
function MainCta({ onClick }: { onClick?: () => void }) {
  return (
    <div 
      className="bg-[#b3141d] content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[16px] py-[12px] relative rounded-[4px] shrink-0 cursor-pointer hover:bg-[#921017] transition-colors" 
      data-name="Main CTA"
      onClick={onClick}
    >
      <Logout />
...
export function ExitModal({ onConfirm, onCancel }: ExitModalProps) {
  return (
    <div className="content-stretch flex flex-col isolate items-center overflow-clip rounded-[8px] shadow-[0px_4px_30px_10px_rgba(0,0,0,0.08),0px_8px_28px_4px_rgba(0,0,0,0.1),0px_6px_22px_4px_rgba(0,0,0,0.12)] bg-white" data-name="Alert Modal">
